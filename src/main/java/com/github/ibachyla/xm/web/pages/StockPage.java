...
public class StockPage extends BasePage<StockPage> {
    ...
    private static final By LONG_SWAP_CELL =
            By.cssSelector(VALUE_CELL_CSS_LOCATOR_TEMPLATE.formatted("swap_value_in_margin_currency_long__value"));
    private static final By SHORT_SWAP_CELL =
            By.cssSelector(VALUE_CELL_CSS_LOCATOR_TEMPLATE.formatted("swap_value_in_margin_currency_short__value"));
    private static final By LIMIT_AND_STOP_LEVELS_CELL =
            By.cssSelector(VALUE_CELL_CSS_LOCATOR_TEMPLATE.formatted("limit_and_stop_levels__title") + " > span");
